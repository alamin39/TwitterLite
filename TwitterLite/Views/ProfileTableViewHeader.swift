...
class ProfileTableViewHeader: UIView {
    ...
    let displayNameLabel: UILabel = {
        let label = UILabel()
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = Auth.auth().currentUser?.email //"Al-Amin"
    ...
    private func addSubviews() {
        addSubview(profileCoverImageView)
    ...
    private func configureStackButton() {
        for (tab, button) in sectionStack.arrangedSubviews.enumerated() {
    ...
    private func configureConstraints() {
        ...
        let profileCoverImageViewConstraints = [
            profileCoverImageView.leadingAnchor.constraint(equalTo: leadingAnchor),
            profileCoverImageView.topAnchor.constraint(equalTo: topAnchor),
            profileCoverImageView.trailingAnchor.constraint(equalTo: trailingAnchor),
            profileCoverImageView.heightAnchor.constraint(equalToConstant: 150)
        ]
        
        let profileAvatarImageViewConstraints = [
            profileAvatarImageView.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 20),
            profileAvatarImageView.centerYAnchor.constraint(equalTo: profileCoverImageView.bottomAnchor, constant: 10),
        ...
        NSLayoutConstraint.activate(profileCoverImageViewConstraints)
